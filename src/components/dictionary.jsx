	...
	const handleDictionary = {
		...
		searchWordsByKeyword:(keyword)=>{
			return dictionary.words.filter((word)=>{
				return word.name.toLowerCase().includes(keyword.toLowerCase()) ||
	...
	return <appContext.Provider value={app}>
		...
		<main id='dictionary'>
			<Routes>
				...
				<Route path={'/add'} element={<AddForm handleDictionary={handleDictionary} editMode={false}/>}/>
				<Route path={'/edit/:wordId'} element={<AddForm handleDictionary={handleDictionary} editMode={true}/>}/>
